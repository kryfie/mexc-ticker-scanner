...
def scan_symbol(symbol: str, cfg: ScanConfig) -> ScanResult:
    ...
    for i in range(1, len(df)):
        r = df.iloc[i]
        p = df.iloc[i - 1]
        needed = [r.ma12, r.ma50, r.ma200, p.ma12, p.ma50, p.ma200, r.m15_open, r.m15_high, r.m15_low, r.m15_close, r.m15_ma12, r.m15_ma200]
        ...
        # M15 wick filter from the updated Pine Script.
        ...
        ma200_up_raw = allow_long and m15_no_lower_wick_above_ma200 and ha_green and ha_no_lower and cross_ha_up and r.ma50 < r.ma12 and r.ma12 < r.ma200
        ma200_down_raw = allow_short and m15_no_upper_wick_below_ma200 and ha_red and ha_no_upper and cross_ha_down and r.ma50 > r.ma12 and r.ma12 > r.ma200
